"""
adopted and modified from https://github.com/mcs07/PubChemPy
"""
...
def request(identifier, namespace="cid", domain="compound", operation=None, output="JSON", searchtype=None, **kwargs):
    ...
    if ('requests_session' in kwargs.keys()):
        ...
        else: requests_session = requests
    else: requests_session = requests
    ...
    try:
        ...
        response = requests_session.post(url=apiurl, data=postdata, timeout=10)
